...
- [ ] T061 Configure GitHub Actions for Maven `verify`, OpenAPI/AsyncAPI drift checks, HTTP and messaging PACT verification, integration suites, Jacoco `>= 80%`, and multi-stage Docker image builds in `.github/workflows/ci.yml`
